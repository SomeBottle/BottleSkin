var MSP = (function (global, undefined) {
	...
	*/
	...
	skin.src = picturename;
	}
	//skin.src = 'file:///E:/Desktop/MC/23297.png';
				...
				fr.onload = function (e) {
					...
					img.onload = function () {
						if(this.width === 64 && this.height === 64) {
							...
							alert("Error: The image must be 64x64 pixels!");
						}
					};
...
$.ajax({
        ...
        success: function(msg){
          ...
          console.log("临时图片删除");
			  ...
			  alert("ERROR!Message:临时图片删除失败！");
		  }
          console.log(data);    //控制台输出
        },
        error:function(msg){
          alert("ERROR!Message:通信失败");
        }
      });
}
setTimeout(delpic,1000);